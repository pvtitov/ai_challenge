...
echo "=========================================="
echo "  aichat-lite Automated Test"
echo "=========================================="
echo ""
echo "Starting aichat-lite with predefined questions..."
echo ""
